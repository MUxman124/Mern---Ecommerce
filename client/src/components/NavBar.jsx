                  ...
                  <div className="flex flex-1 items-center justify-end">
                    <div className="flex items-center lg:ml-8">
                      <div className="flex space-x-8">
                        <Link to="/admin/login">
                          <button className="p-1 px-2 font-[500] text-sm bg-lime-500 text-white rounded-full">
                            Admin Panel
                          </button>
                        </Link>
                      ...
                      <Link to="/cart">
                        <div className="flow-root">
                          <a className="group relative -m-2 flex items-center p-2">
                            ...
                            />
                            <span className="ml-2 absolute top-[8px] right-[10px] transform translate-x-1/2 -translate-y-1/2 flex size-5 items-center justify-center rounded-full bg-lime-600 text-white p-2 text-sm font-medium ">
                              {cart.length}
                            </span>
